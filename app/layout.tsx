...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>awaydayz - Find your sports bar</title>
        <meta name="description" content="Find the best sports bars showing your team's match in NYC" />
      </head>
      <body>
        <header className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-lg border-b border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
            <Link href="/" className="flex items-center hover:opacity-80 transition-opacity">
              <span className="text-2xl font-black text-white" style={{ fontFamily: 'Arial, sans-serif', letterSpacing: '-0.02em' }}>
                awaydayz
              </span>
            </Link>
        ...
        <footer className="border-t border-white/10 bg-gray-900/50 backdrop-blur-lg mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
            ...
            <div className="flex justify-center gap-6 mb-8">
              ...
              <a 
                href="https://www.youtube.com/@themidfieldbattle" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="YouTube"
              ...
              <a 
                href="https://open.spotify.com/show/0oWBYmX7xSpwF8tbcHUMQU" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Spotify"
              ...
              <a 
                href="https://www.tiktok.com/@themidfieldbattle" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="TikTok"
